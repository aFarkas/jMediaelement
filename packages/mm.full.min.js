...
"f4v"],"video/3gpp":["3gp","3gpp"],"video/webm":["webm"]}};a.extend(h,{jsPath:function(){var b=a("script");b=b[b.length-1].src.split("?")[0];return b.slice(0,b.lastIndexOf("/")+1)}(),extendWithData:function(){var b={string:1,number:1,"boolean":1};return function(e,g,l){l||(l=g);a.each(l,a.isArray(l)?function(n,p){h.getData(e,p,g)}:function(n,p){b[typeof p]&&h.getData(e,n,g)});return g}}(),getData:function(){var b=function(e,g){e=e.getAttribute("data-"+g);if(!(!e&&e!==""))return e*1==e?parseFloat(e,
10):e==="false"?false:e==="true"?true:e};return function(e,g,l){var n=g;l=l||{};if(typeof g==="string")g=[n];a.each(g,a.isArray(g)?function(p,s){p=b(e,s);if(p!==undefined)l[s]=p}:function(p){var s=b(e,p);if(s!==undefined)l[p]=s});return l}}(),registerMimetype:function(b,e){arguments.length===1?a.each(D,function(g){h.registerMimetype(g,b)}):a.each(e,function(g,l){if(D[b][g])D[b][g]=[];D[b][g]=D[b][g].concat(l)})},_showMimeTypes:function(){window.console&&console.log(D)},add:function(b,e,g){if(!this.apis[e][b]){this.apis[e][b]=
