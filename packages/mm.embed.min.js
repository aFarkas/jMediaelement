...
i+'" value="'+l+'" />'});e+="</object>";a.outerHTML=e;e=t.getElementById(b)}if(e){e.setAttribute("width","100%");e.setAttribute("height","100%");e.style.display.width="100%";e.style.display.height="100%"}c(window).unload(function(){jQuery.cleanData([e]);e=null});return e}});j.add("nativ","video",{});j.add("nativ","audio",{});c.fn.mediaElementEmbed=function(a){a=c.extend(true,{},c.fn.mediaElementEmbed.defaults,a);return this.each(function(){var b=this.nodeName.toLowerCase();if(!(b!=="video"&&b!=="audio")){var d=
this;a.removeControls&&c.attr(this,"controls",false);var f=j.helper._create(b,"nativ",this,a);f.name="nativ";f.apis.nativ.apiElem=this;f.apis.nativ.visualElem=c(this);c.each(j.apis[b],function(g){g!=="nativ"&&j.helper._create(b,g,d,a)});a.debug||!c.support.mediaElements||this.error?s(this,a):f.apis[f.name]._init();c(this).bind("mediaerror",function(){f.name==="nativ"&&s(this,a)}).bind("loadedmetadata",h)}})};c.fn.mediaElementEmbed.defaults={debug:false,removeControls:false,apiOrder:[]};if(c.cleanData){var z=
c.cleanData;c.cleanData=function(a){z(a);for(var b=0,d=a.length;b<d;b++)if(a[b].nodeName==="OBJECT")try{for(var f in a[b])if(typeof a[b][f]==="function")a[b][f]=null}catch(g){}}}})(jQuery);
