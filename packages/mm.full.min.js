...
g,l){if(!(b.nodeName&&o.test(b.nodeName)&&(B[e]||u[e]||r[e])))return q(b,e,g,l);var n;if(g===undefined){if(u[e])return typeof b[e]==="boolean"?b[e]:!!(b.attributes[e]||{}).specified;if(r[e])return a.support.video&&b[e]||h.makeAbsURI(b.getAttribute(e));switch(e){case "srces":if(n=a.data(b,"jme-srces"))break;if(n=a.attr(b,"src"))n=[{src:n,type:b.getAttribute("type"),media:b.getAttribute("media")}];else{n=[];a("source",b).each(function(){n.push({src:a.attr(this,"src"),type:this.getAttribute("type"),
media:this.getAttribute("media")})});n.length||a("a.source",b).each(function(){n.push({src:this.href,type:this.getAttribute("type"),media:this.getAttribute("data-media")})})}break;case "getConfig":n={};a.each(["autoplay","loop","controls","poster","preload"],function(p,s){n[s]=a.attr(b,s)});break;case "preload":n=b.preload||b.getAttribute("preload");if(n==="")n="auto";A[n]||(n="metadata");break}return n}else if(u[e]){g=!!g;b[e]=g;e==="autoplay"&&z.changeAutoplay(b,g);if(g){b[e]=g;b.setAttribute(e,
e)}else{b[e]=g;b.removeAttribute(e)}}else if(r[e])b.setAttribute(e,g);else if(e==="srces"){a("source, a.source",b).remove();b.removeAttribute("src");g=a.isArray(g)?g:[g];z.addSrces(b,g,l)||a.each(g,function(p,s){n=c.createElement("source");if(typeof s==="string")s={src:s};n.setAttribute("src",s.src);s.type&&n.setAttribute("type",s.type);s.media&&n.setAttribute("media",s.media);b.appendChild(n)})}else if(e==="getConfig")a.each(g,function(p,s){a.attr(b,p,s)});else if(e==="preload"){if(g==="")g="auto";
else A[g]||(g="metadata");z.change(b,g,l);b.setAttribute(e,g)}};a.event.special.mediaerror={setup:function(){var b=a(this).bind("error",a.event.special.mediaerror.handler).bind("native_mediareset",w);setTimeout(function(){b.each(w)},0)},teardown:function(){a(this).unbind("error",a.event.special.mediaerror.handler).find("source").unbind("error",v)},handler:function(b){if(!a.data(this,"calledMediaError")){b=a.extend({},b||{},{type:"mediaerror"});a.data(this,"calledMediaError",true);return a.event.handle.apply(this,
...
if(this.isJMEReady()&&(this.name!=="nativ"||a.support.mediaElements))d.call(this.element,m,m);else{j=j||"jmediaelement";var q=this,o=function(){a(q.element).unbind("mmAPIReady."+j,o).unbind("jmeflashRefresh."+j,o);d.call(q.element,m,m)};a(this.element).bind("mmAPIReady."+j,o).bind("jmeflashRefresh."+j,o)}},unAPIReady:function(d){a(this.element).unbind("mmAPIReady."+d)},_adjustPluginLoop:function(d){var j=a.attr(this.element,"loop"),m=this;j!==d&&setTimeout(function(){m[j?"play":"pause"]()},0)},_format:w.formatTime,
getFormattedDuration:function(){return this._format(this.getDuration())},getFormattedTime:function(){return this._format(this.currentTime())},loadSrc:function(d,j,m,q){if(d){a.attr(this.element,"srces",d);d=a.isArray(d)?d:[d]}else d=a.attr(this.element,"srces");if(j!==undefined)j?a.attr(this.element,"poster",j):a(this.element).removeAttr("poster");else j=a.attr(this.element,"poster");if(typeof m=="string"){var o=a.data(this.element,"mediaElemSupport");o.mediaName&&o.mediaName.text(m)}this._isResetting=
...
this.readyState===4){u.relStart=0;u.relLoaded=100;d._trigger(u)}return u.relLoaded},q=function(){if(m.call(d.element,{type:"ipadprogress"})>=100||d.element.readyState===1)clearInterval(o)},o;a(d.element).bind("progress load",m);"buffered"in d.element&&a(d.element).bind("play waiting loadstart",function(){clearInterval(o);if(d.isAPIActive){o=setInterval(q,333);q()}})},c={isTechAvailable:a.support.mediaElements,_init:function(){var d=this,j=this.apiElem.muted,m=false,q=function(o){clearInterval(m);
...
!a.attr(this,"loop")){d._stopEvent("pause",true);this.pause()}},timeupdate:function(){var o={type:"timechange",time:this.currentTime};if(this.duration){o.duration=this.duration;o.timeProgress=o.time/o.duration*100}d._trigger(o)},progress:function(){!d.loadedmeta&&this.duration&&d._trigger({type:"loadedmeta",duration:this.duration})},loadedmetadata:function(){d._trigger({type:"loadedmeta",duration:this.duration})}}).bind("play pause playing waiting ended",function(o,r){if(!(!d.isAPIActive||d.totalerror||
o.bubbles)){var u=this.parentNode||this.ownerDocument;if(!o.isPropagationStopped()&&u){o.bubbles=true;r=a.makeArray(r);r.unshift(o);a.event.trigger(o,r,u,true)}}}).bind("play playing",function(o){if(!d.isAPIActive&&o.originalEvent&&!d.element.paused&&!d.element.ended)try{d.element.pause()}catch(r){}}).bind("mediareset",q).bind("ended play pause waiting playing",function(o){if(!d.isAPIActive&&o.originalEvent&&(o.originalEvent.mediaAPI==="nativ"||!o.originalEvent.mediaAPI)||d._stoppedEvents[o.type])o.stopImmediatePropagation()});
q("initial");a.support.mediaLoop||a(this.element).bind("ended",function(){if(d.isAPIActive&&a.attr(this,"loop")){var o=this;setTimeout(function(){a.attr(o,"loop")&&o.play()},0)}});if(!this.element.error)if(this.element.readyState>0)this._trigger({type:"loadedmeta",duration:this.element.duration});else if(this.element.networkState!==2||"webkitPreservesPitch"in this.element)this._trigger("mmAPIReady")},play:function(){this.element.play()},pause:function(){this._allowEvent("pause");this.element.pause()},
...
new ActiveXObject("ShockwaveFlash.ShockwaveFlash");k(i);i=null}catch(d){}})();var c={isTechAvailable:function(){return a.support.flash9},_extendJWLoad:function(i,k,d){if(i){d=d||this.element;x.extendWithData(d,k,["type","provider","stretching","bufferlength"]);if(!this.canPlaySrc(i)){if(!k.provider)k.provider=h[this.nodeName];if(!k.type)k.type=h[this.nodeName]}return k}},_embed:function(i,k,d,j){var m=this.embedOpts.jwPlayer,q=a.extend({},m.vars,{file:i,id:k}),o=a.extend({name:k,data:m.path},m.attrs,
v),r=a.extend({movie:m.path},m.params),u=[],B=this;this._extendJWLoad(i,q);if(d.poster)q.image=d.poster;q.autostart=""+d.autoplay;q.repeat=d.loop?"single":"false";q.controlbar=d.controls?"bottom":"none";if(!d.controls&&this.nodeName!=="audio"&&r.wmode===undefined)r.wmode="transparent";if(!d.controls&&m.hideIcons&&r.wmode==="transparent"||m.hideIcons===true){q.icons="false";q.showicons="false"}if(r.wmode==="transparent"&&!q.screencolor&&!o.bgcolor){q.screencolor="ffffffff";o.bgcolor="#000000"}r.flashvars=
[];a.each(q,function(A,z){r.flashvars.push(f(A)+"="+f(z))});a.each(m.plugins,function(A,z){u.push(z)});u.length&&r.flashvars.push("plugins="+u.join(","));r.flashvars=r.flashvars.join("&");j(x.embedObject(this.visualElem[0],k,o,r,w,"Shockwave Flash"));setTimeout(function(){var A=a("object",B.visualElem)[0];if(!A||A.style.display==="none"&&a("> *",B.visualElem).length>1){a("div[bgactive]",B.visualElem).css({width:"100%",height:"100%"});B._trigger("flashblocker")}},9)},canPlaySrc:function(i){var k=x.fn.canPlaySrc.apply(this,
arguments),d=-1;d=i.src||i;if(!k&&typeof d==="string"){d=d.indexOf("youtube.com/");if(d<15&&d>6)k="maybe"}return k},canPlayCodecs:["avc1.42E01E","mp4a.40.2","avc1.58A01E","avc1.4D401E","avc1.64001E","VP6","mp3","AAC"],canPlayContainer:["video/3gpp","video/x-msvideo","video/quicktime","video/x-m4v","video/mp4","video/m4p","video/x-flv","video/flv","audio/mpeg","audio/mp3","audio/x-fla","audio/fla","youtube/flv","jwplayer/jwplayer"]};x.add("jwPlayer","video",c);x.add("jwPlayer","audio",c)})(jQuery);
