...
var e;if(navigator.plugins&&navigator.plugins[k]){e=t.createElement("object");c.each(d,function(i,l){e.setAttribute(i,l)});c.each(f,function(i,l){var y=t.createElement("param");y.setAttribute("name",i);y.setAttribute("value",l);e.appendChild(y)});e.setAttribute("id",b);e.setAttribute("name",b);a.parentNode.replaceChild(e,a)}else if(window.ActiveXObject){alert("df");e="<object";c.each(c.extend({},d,g),function(i,l){e+=" "+i+'="'+l+'"'});e+=' name="'+b+'"';e+=' id="'+b+'"';e+=">";c.each(f,function(i,
l){e+=' <param name="'+i+'" value="'+l+'" />'});e+="</object>";a.outerHTML=e;e=t.getElementById(b)}if(e){e.setAttribute("width","100%");e.setAttribute("height","100%");e.style.display.width="100%";e.style.display.height="100%"}c(window).unload(function(){jQuery.cleanData([e]);e=null});return e}});j.add("nativ","video",{});j.add("nativ","audio",{});c.fn.mediaElementEmbed=function(a){a=c.extend(true,{},c.fn.mediaElementEmbed.defaults,a);return this.each(function(){var b=this.nodeName.toLowerCase();
if(!(b!=="video"&&b!=="audio")){var d=this;a.removeControls&&c.attr(this,"controls",false);var f=j.helper._create(b,"nativ",this,a);f.name="nativ";f.apis.nativ.apiElem=this;f.apis.nativ.visualElem=c(this);c.each(j.apis[b],function(g){g!=="nativ"&&j.helper._create(b,g,d,a)});a.debug||!c.support.mediaElements||this.error?s(this,a):f.apis[f.name]._init();c(this).bind("mediaerror",function(){f.name==="nativ"&&s(this,a)}).bind("loadedmetadata",h)}})};c.fn.mediaElementEmbed.defaults={debug:false,removeControls:false,
apiOrder:[]};if(c.cleanData){var z=c.cleanData;c.cleanData=function(a){z(a);for(var b=0,d=a.length;b<d;b++)if(a[b].nodeName==="OBJECT")try{for(var f in a[b])if(typeof a[b][f]==="function")a[b][f]=null}catch(g){}}}})(jQuery);
...
true}catch(h){}return c.support.vlc},_embed:function(h,j,m,t){var n=this.embedOpts.vlc,v=c.extend({},n.attrs,{width:"100%",height:"100%"},r);m=c.extend({},n.params,{src:h,ShowDisplay:"True",autoplay:""+m.autoplay,autoloop:""+m.loop});j=o.embedObject(this.visualElem[0],j,v,m,p,"VLC Multimedia Plug-in");this._currentSrc=h;t(j)},canPlayCodecs:["avc1.42E01E","mp4a.40.2","avc1.58A01E","avc1.4D401E","avc1.64001E","theora","vorbis"],canPlayContainer:["video/3gpp","video/x-msvideo","video/quicktime","video/x-m4v",
"video/mp4","video/m4p","video/x-flv","video/flv","audio/mpeg","audio/x-fla","audio/fla","video/ogg","video/x-ogg","audio/x-ogg","audio/ogg","application/ogg","application/x-ogg"]};o.add("vlc","video",s);o.add("vlc","audio",s)})(jQuery);
