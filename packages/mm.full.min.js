...
(function(a){var t={type:"application/x-shockwave-flash"},v={classid:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},x=a.multimediaSupport;a.extend(a.fn.jmeEmbed.defaults,{jwPlayer:{path:x.jsPath+"player.swf",hideIcons:"auto",vars:{},attrs:{},params:{allowscriptaccess:"always",allowfullscreen:"true"}}});var w={A:/&amp;/g,a:/&/g,e:/\=/g,q:/\?/g},o=function(d){return d.replace(w.A,"%26").replace(w.a,"%26").replace(w.e,"%3D").replace(w.q,"%3F")};(function(){a.support.flash9=false;var d=x.getPluginVersion("Shockwave Flash"),
...
[];a.each(d,function(k,n){j.flashvars.push(o(k)+"="+o(n))});j.flashvars=j.flashvars.join("&");b(x.embedObject(this.visualElem[0],g,h,j,v,"Shockwave Flash"))},canPlayCodecs:["avc1.42E01E","mp4a.40.2","avc1.58A01E","avc1.4D401E","avc1.64001E","VP6","mp3","AAC"],canPlayContainer:["video/3gpp","video/x-msvideo","video/quicktime","video/x-m4v","video/mp4","video/m4p","video/x-flv","video/flv","audio/mpeg","audio/mp3","audio/x-fla","audio/fla"]};x.add("jwPlayer","video",y);x.add("jwPlayer","audio",y)})(jQuery);
(function(a){function t(d){d=d.replace(w,"");return a.data(v.getElementById(d),"mediaElemSupport").apis.jwPlayer}var v=document,x=a.multimediaSupport,w=/^jwPlayer-/,o={View:{PLAY:function(d){if(d=d.state&&t(d.id)){d._trigger("play");d._$isPlaystate=true}}},Model:{META:function(d){if(d.type==="metadata"){var g=t(d.id);g&&g._trigger({type:"loadedmeta",duration:d.duration})}},TIME:function(d){var g=t(d.id),l={type:"timechange",time:d.position};if(g){g.loadedmeta||g._trigger({type:"loadedmeta",duration:d.duration});
...
(function(a){a.extend(a.fn.jmeEmbed.defaults,{vlc:{params:{},attrs:{}}});var t=a.multimediaSupport,v={pluginspage:"http://www.videolan.org",version:"VideoLAN.VLCPlugin.2",progid:"VideoLAN.VLCPlugin.2",type:"application/x-vlc-plugin",events:"True"},x={classid:"clsid:9BE31822-FDAD-461B-AD51-BE1D1C159921"},w={isTechAvailable:function(){if(a.support.vlc!==undefined)return a.support.vlc;a.support.vlc=false;a.support.vlcWEBM=false;var o=t.getPluginVersion("VLC Multimedia Plug-in");if(o[0]>=0.9){if(o[0]>=
1.1)a.support.vlcWEBM=true;a.support.vlc=true}else if(window.ActiveXObject)try{if(o=new ActiveXObject("VideoLAN.VLCPlugin.2")){if(o.VersionInfo&&parseFloat(o.VersionInfo,10)>=1.1)a.support.vlcWEBM=true;a.support.vlc=true}}catch(y){}if(a.support.vlcWEBM){w.canPlayCodecs.push("VP8");w.canPlayCodecs.push("VP8.0");w.canPlayContainer.push("video/webm");w.canPlayContainer.push("audio/webm")}return a.support.vlc},_embed:function(o,y,d,g){var l=this.embedOpts.vlc,b=a.extend(window.ActiveXObject?{}:{data:o},
l.attrs,v);l=a.extend({},l.params,{Src:o,ShowDisplay:"True",autoplay:""+d.autoplay,autoloop:""+d.loop});y=t.embedObject(this.visualElem[0],y,b,l,x,"VLC Multimedia Plug-in");this._currentSrc=o;this._loop=d.loop;g(y);if(!d.autoplay&&window.ActiveXObject)try{y.playlist.playItem(y.playlist.add(o," ",":no-video-title-show"));y.playlist.items.clear();y.playlist.stop()}catch(e){}},canPlayCodecs:["avc1.42E01E","mp4a.40.2","avc1.58A01E","avc1.4D401E","avc1.64001E","theora","vorbis","VP6","mp3","AAC"],canPlayContainer:["video/3gpp",
...
if(g&&g>1&&this.data.time!==e.time){if(b.duration){e.duration=b.duration;e.timeProgress=d.input.position*100}this.data.time=e.time;v(e,l)}e={type:"mute",isMuted:d.audio.mute};if(e.isMuted!==this.data.isMuted){this.data.isMuted=e.isMuted;v(e,l)}e={type:"volumelevelchange",volumelevel:d.audio.volume/2};if(e.volumelevel!==this.data.volumelevel){this.data.volumelevel=e.volumelevel;v(e,l)}if(g!==this.data.state){this.data.state=g;o[g]&&v(o[g],l);if(o[g]==="ended"){d.playlist.stop();l._adjustPluginLoop(l._loop)}if(g===
3)w.start(l);else if(g===4||g===5||g===6||g===7)w.end(l)}},play:function(){this.apiElem.playlist.play();this._trigger("play");w.start(this);x(this);if(this._currentTimeAdjust!==false){try{this.apiElem.input.time=this._currentTimeAdjust}catch(d){}this._resetCurrentTime()}},pause:function(){if(o[this.apiElem.input.state]==="playing"){w.end(this);this.apiElem.playlist.togglePause();x(this)}},_isPlaying:function(){var d=false;try{d=o[this.apiElem.input.state]==="playing"}catch(g){}return d},_mmload:function(d,
...
this._currentTimeAdjust=false},currentTime:function(d){try{if(!isFinite(d))return this.apiElem.input?this.apiElem.input.time/1E3:0;var g;if(!this.loadedmeta){g=o[this.apiElem.input.state];this.play()}this._currentTimeAdjust=d*1E3;clearTimeout(this._currentTimeTimer);this._currentTimeTimer=setTimeout(a.proxy(this,"_resetCurrentTime"));this.apiElem.input.time=this._currentTimeAdjust;x(this);g&&g!=="playing"&&g!=="waiting"&&this.pause()}catch(l){if(!isFinite(d))return 0}},getDuration:function(){var d;
