...
a=a.src}var d=r(a),e="";b.each(u[this.nodeName],function(h,f){if(b.inArray(d,f)!==-1){e=c.canPlayType(h);return false}});return e},canPlaySrces:function(a){a=a||b.attr(this.html5elem,"srces");b.isArray(a)||(a=[a]);var c=this,d=false,e="";b.each(a,function(h,f){if(d=c.canPlaySrc(f)){e=f;return false}});return e},_setActive:b.noop,_setInactive:b.noop,_trigger:b.noop},apis:{audio:{},video:{}},helper:{extractContainerCodecsFormType:function(a){a=a.split(/\s*;\s*/g);if(a[1]&&a[1].indexOf("codecs")!==-1)a[1]=
...
{};h.apis[c].embedOpts=e}return h},_setAPIActive:function(a,c){var d=b.data(a,"mediaElemSupport"),e=d.name;if(e===c)return true;var h=d.apis[e].apiElem,f=d.apis[c]&&d.apis[c].apiElem,g=false;if(f&&f.nodeName){if(d.nodeName!=="audio"||b.attr(a,"controls"))d.apis[c].visualElem.css({width:d.apis[e].visualElem.width(),height:d.apis[e].visualElem.height(),visibility:"",display:""});d.apis[c]._setActive(e);g=true;d.apis[c]._trigger({type:"apiActivated",api:c})}if(h&&h.nodeName){if(e==="nativ")h.style.display=
"none";else d.apis[e].visualElem.css({height:0,width:0,overflow:"hidden",visibility:"hidden"});d.apis[e]._setInactive(c);d.apis[g?c:e]._trigger({type:"apiInActivated",api:e})}d.name=c;return g}},getSuitedPlayers:function(a,c){var d=b.data(a,"mediaElemSupport");if(d&&d.apis){d=d.apis;var e=b.attr(a,"srces"),h=false,f=function(g,i){if(!(!i.isTechAvailable||b.isFunction(i.isTechAvailable)&&!i.isTechAvailable())){if(i=i.canPlaySrces(e))h={src:i.src||i,name:g};return h}};if(!e.length)return"noSource";
c?b.each(c,function(g,i){return!f(i,d[i])}):b.each(d,function(g,i){return!f(g,i)});return h}},_embedApi:function(a,c,d){var e=b.attr(a,"getConfig"),h=b(a),f=a.id;if(!f){m++;f=d.nodeName+"-"+m;a.id=f}d.apis[c.name].visualElem=b('<div class="media-element-box mm-'+d.nodeName+'-box" />').insertBefore(a);d.nodeName==="audio"&&!e.controls?d.apis[c.name].visualElem.css({height:0,width:0,overflow:"hidden"}):d.apis[c.name].visualElem.css({width:h.width(),height:h.height()});d.apis[c.name]._embed(c.src,d.name+
"-"+f,e,function(g){d.apis[c.name].apiElem=g;b(g).addClass(d.nodeName);d.apis[c.name]._init();d.apis[c.name]._trigger({type:"apiActivated",api:c.name})})},getPluginVersion:function(a){var c=navigator.plugins&&navigator.plugins[a];a=-1;if(c)if((c=(c.description||"").match(/(\d+\.\d+)/)||["0"])&&c[0])a=parseFloat(c[0],10);return a},embedObject:function(a,c,d,e,h){a=b("<div />").appendTo(a)[0];var f;if(!window.ActiveXObject||!a.outerHTML){f=t.createElement("object");b.each(d,function(g,i){f.setAttribute(g,
i)});b.each(e,function(g,i){var l=t.createElement("param");l.setAttribute("name",g);l.setAttribute("value",i);f.appendChild(l)});f.setAttribute("id",c);f.setAttribute("name",c);a.parentNode.replaceChild(f,a)}else{f="<object";b.each(b.extend({},d,h),function(g,i){f+=" "+g+'="'+i+'"'});f+=' name="'+c+'"';f+=' id="'+c+'"';f+=">";b.each(e,function(g,i){f+=' <param name="'+g+'" value="'+i+'" />'});f+="</object>";a.outerHTML=f;f=t.getElementById(c)}if(f){f.setAttribute("width","100%");f.setAttribute("height",
"100%");f.style.display.width="100%";f.style.display.height="100%"}b(window).unload(function(){jQuery.cleanData([f]);f=null});return f}});j.add("nativ","video",{});j.add("nativ","audio",{});b.fn.mediaElementEmbed=function(a){a=b.extend(true,{},b.fn.mediaElementEmbed.defaults,a);return this.each(function(){var c=this.nodeName.toLowerCase();if(!(c!=="video"&&c!=="audio")){var d=this;a.removeControls&&b.attr(this,"controls",false);var e=j.helper._create(c,"nativ",this,a);e.name="nativ";e.apis.nativ.apiElem=
this;e.apis.nativ.visualElem=b(this);b.each(j.apis[c],function(h){h!=="nativ"&&j.helper._create(c,h,d,a)});a.debug||!b.support.mediaElements||this.error?s(this,a):e.apis[e.name]._init();b(this).bind("mediaerror",function(){e.name==="nativ"&&s(this,a)}).bind("loadedmetadata",k)}})};b.fn.mediaElementEmbed.defaults={debug:false,removeControls:false,apiOrder:[]};if(b.cleanData){var y=b.cleanData;b.cleanData=function(a){y(a);for(var c=0,d=a.length;c<d;c++)if(a[c].nodeName==="OBJECT")try{for(var e in a[c])if(typeof a[c][e]===
"function")a[c][e]=null}catch(h){}}}})(jQuery);
