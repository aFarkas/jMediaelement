...
navigator.plugins&&navigator.plugins[a];a=-1;if(c)if((c=(c.description||"").match(/(\d+\.\d+)/)||["0"])&&c[0])a=parseFloat(c[0],10);return a},embedObject:function(a,c,d,e,h){a=b("<div />").appendTo(a)[0];var f;if(!window.ActiveXObject||!a.outerHTML){f=t.createElement("object");b.each(d,function(g,j){f.setAttribute(g,j)});b.each(e,function(g,j){var l=t.createElement("param");l.setAttribute("name",g);l.setAttribute("value",j);f.appendChild(l)});f.setAttribute("id",c);f.setAttribute("name",c);a.parentNode.replaceChild(f,
a)}else{f="<object";b.each(b.extend({},d,h),function(g,j){f+=" "+g+'="'+j+'"'});f+=' name="'+c+'"';f+=' id="'+c+'"';f+=">";b.each(e,function(g,j){f+=' <param name="'+g+'" value="'+j+'" />'});f+="</object>";a.outerHTML=f;f=t.getElementById(c)}if(f){f.setAttribute("width","100%");f.setAttribute("height","100%");f.style.display.width="100%";f.style.display.height="100%"}b(window).unload(function(){jQuery.cleanData([f]);f=null});return f}});k.add("nativ","video",{});k.add("nativ","audio",{});b.fn.mediaElementEmbed=
function(a){a=b.extend(true,{},b.fn.mediaElementEmbed.defaults,a);return this.each(function(){var c=this.nodeName.toLowerCase();if(!(c!=="video"&&c!=="audio")){var d=this;if(a.removeControls){this.controls=false;b(this).removeAttr("controls")}var e=k.helper._create(c,"nativ",this,a);e.name="nativ";e.apis.nativ.apiElem=this;b.each(k.apis[c],function(h){h!=="nativ"&&k.helper._create(c,h,d,a)});a.debug||!b.support.mediaElements||this.error?s(this,a):e.apis[e.name]._init();b(this).bind("mediaerror",function(){e.name===
"nativ"&&s(this,a)}).bind("loadedmetadata",i)}})};b.fn.mediaElementEmbed.defaults={debug:false,removeControls:false,apiOrder:[]};if(b.cleanData){var y=b.cleanData;b.cleanData=function(a){y(a);for(var c=0,d=a.length;c<d;c++)if(a[c].nodeName==="OBJECT")try{for(var e in a[c])if(typeof a[c][e]==="function")a[c][e]=null}catch(h){}}}})(jQuery);
