...
{};h.apis[c].embedOpts=e}return h},_setAPIActive:function(a,c){var d=b.data(a,"mediaElemSupport"),e=d.name;if(e===c)return true;var h=d.apis[e].apiElem,f=d.apis[c]&&d.apis[c].apiElem,g=false;if(f&&f.nodeName){if(d.nodeName!=="audio"||b.attr(a,"controls"))d.apis[c].visualElem.css({width:d.apis[e].visualElem.width(),height:d.apis[e].visualElem.height(),visibility:"",display:""});d.apis[c]._setActive(e);g=true}if(h&&h.nodeName){if(e==="nativ")h.style.display="none";else d.apis[e].visualElem.css({height:0,
